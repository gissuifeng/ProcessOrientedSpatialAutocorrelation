...
def read_sts(file_path):
    sts = np.loadtxt(file_path, delimiter=",", usecols=(0, 119))
    num = len(sts)
    return sts, num
...
if __name__ == '__main__':
    sts, num = read_sts(r".\dataset\airPollutantData\sts_data.csv")
    weight = read_spatial_weight_matrix(r".\dataset\airPollutantData\spatial_weight_matrix.csv", num)
    ...
    output_local_result(local_s, local_p, r".\result\airPollutantResult")
